 ...
 */
class MatiereEvaluation extends \SchoolBundle\Entity\MatiereEvaluation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'matiere', 'classe', 'evaluation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MatiereEvaluation $proxy) {
