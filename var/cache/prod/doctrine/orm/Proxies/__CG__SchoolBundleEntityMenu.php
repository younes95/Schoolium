 ...
 */
class Menu extends \SchoolBundle\Entity\Menu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SchoolBundle\\Entity\\Menu' . "\0" . 'ecole', '' . "\0" . 'SchoolBundle\\Entity\\Menu' . "\0" . 'id', '' . "\0" . 'SchoolBundle\\Entity\\Menu' . "\0" . 'jour', '' . "\0" . 'SchoolBundle\\Entity\\Menu' . "\0" . 'menu'];
        }
