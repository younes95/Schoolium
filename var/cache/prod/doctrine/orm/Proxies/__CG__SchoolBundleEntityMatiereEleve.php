 ...
 */
class MatiereEleve extends \SchoolBundle\Entity\MatiereEleve implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'matiere', 'eleve', 'evaluation', '' . "\0" . 'SchoolBundle\\Entity\\MatiereEleve' . "\0" . 'note'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MatiereEleve $proxy) {
    ...
    public function setEleve(\UserBundle\Entity\Eleve $eleve = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEleve', [$eleve]);
    ...
    public function getEleve()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEleve', []);
