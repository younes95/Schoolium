 ...
 */
class Eleve extends \UserBundle\Entity\Eleve implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'notes', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'retards', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'absences', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'classe', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'annee', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'ecole', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'transport', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'parent', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'typeUser', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'photo', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'nom', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'prenom', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'dateDeNaissance', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'lieuDeNaissance', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'nationalite', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'adresse', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'codePostal', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'mobile', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'telephone', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'genre', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'ecoleID', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'groupeSanguin', '' . "\0" . 'UserBundle\\Entity\\Eleve' . "\0" . 'commentaire', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
