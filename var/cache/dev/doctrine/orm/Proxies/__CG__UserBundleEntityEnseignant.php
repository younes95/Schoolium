 ...
 */
class Enseignant extends \UserBundle\Entity\Enseignant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'isResponsable', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'matsEns', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'ecole', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'typeUser', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'photo', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'nom', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'prenom', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'genre', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'dateDeNaissance', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'dateDEntree', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'lieuDeNaissance', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'cIN', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'adresse', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'codePostal', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'telephone', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'typeContrat', '' . "\0" . 'UserBundle\\Entity\\Enseignant' . "\0" . 'commentaire', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
